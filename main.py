...
class Main(object):
    def __init__(self,master):
        ...
        self.img_library=PhotoImage(file='icons/library33.png')
...
#########################################Tabs###############################################################
    ###################################tab1#################################
        ...
        self.tabs.add(self.tab2,text='Statistics',image=self.tab1_icon,compound=LEFT)
...
class GiveBook(Toplevel):
    def __init__(self):
        ...
        # headding, image
        self.top_image = PhotoImage(file='icons/members.png')
